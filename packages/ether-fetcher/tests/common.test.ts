import {
  ...
  DEFAULT_TESTNET_BASE_GOERLI_API_BASE_URL,
  DEFAULT_TESTNET_ARBITRUM_GOERLI_API_BASE_URL,
  DEFAULT_TESTNET_OPTIMISM_GOERLI_API_BASE_URL,
  createAxiosInstance,
...
describe('test common.ts', () => {
  test('test getDefaultScanApiBaseUrl', async () => {
    ...
    expect(getDefaultScanApiBaseUrl(84531)).toBe(DEFAULT_TESTNET_BASE_GOERLI_API_BASE_URL);
    expect(getDefaultScanApiBaseUrl(421613)).toBe(DEFAULT_TESTNET_ARBITRUM_GOERLI_API_BASE_URL);
    expect(getDefaultScanApiBaseUrl(420)).toBe(DEFAULT_TESTNET_OPTIMISM_GOERLI_API_BASE_URL);
